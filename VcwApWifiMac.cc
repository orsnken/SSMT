...
NS_LOG_COMPONENT_DEFINE ("VcwApWifiMac");

NS_OBJECT_ENSURE_REGISTERED (VcwApWifiMac);

TypeId
VcwApWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::VcwApWifiMac")
    .SetParent<InfrastructureWifiMac> ()
    .SetGroupName ("Wifi")
    .AddConstructor<VcwApWifiMac> ()
    .AddAttribute ("BeaconInterval",
                   "Delay between two beacons",
                   TimeValue (MicroSeconds (102400)),
                   MakeTimeAccessor (&VcwApWifiMac::GetBeaconInterval,
                                     &VcwApWifiMac::SetBeaconInterval),
                   MakeTimeChecker ())
    .AddAttribute ("CfpMaxDuration", "The maximum size of the CFP (used when AP supports PCF)",
                   TimeValue (MicroSeconds (51200)),
                   MakeTimeAccessor (&VcwApWifiMac::GetCfpMaxDuration,
                                     &VcwApWifiMac::SetCfpMaxDuration),
                   MakeTimeChecker ())
    ...
    .AddAttribute ("EnableNonErpProtection", "Whether or not protection mechanism should be used when non-ERP STAs are present within the BSS."
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&VcwApWifiMac::m_enableNonErpProtection),
                   MakeBooleanChecker ())
    .AddAttribute ("RifsMode", "If non-HT STAs are detected, whether to force RIFS to be disabled within the BSS."
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&VcwApWifiMac::m_disableRifs),
                   MakeBooleanChecker ())
  ;
  return tid;
}

VcwApWifiMac::VcwApWifiMac ()
  : m_enableBeaconGeneration (false)
{
  ...
  m_beaconTxop->SetTxOkCallback (MakeCallback (&VcwApWifiMac::TxOk, this));
  m_rxMiddle->SetPcfCallback (MakeCallback (&VcwApWifiMac::SendNextCfFrame, this));
...
void
VcwApWifiMac::SetAddress (Mac48Address address)
{
...
void
VcwApWifiMac::SetBeaconGeneration (bool enable)
{
  ...
  if (!enable)
    ...
    {
      m_beaconEvent = Simulator::ScheduleNow (&VcwApWifiMac::SendOneBeacon, this);
    }
  m_enableBeaconGeneration = enable;
}

Time
VcwApWifiMac::GetBeaconInterval (void) const
{
  NS_LOG_FUNCTION (this);
...
Time
VcwApWifiMac::GetCfpMaxDuration (void) const
{
  NS_LOG_FUNCTION (this);
...
void
VcwApWifiMac::SetWifiRemoteStationManager (const Ptr<WifiRemoteStationManager> stationManager)
{
...
void
VcwApWifiMac::SetLinkUpCallback (Callback<void> linkUp)
{
...
void
VcwApWifiMac::SetBeaconInterval (Time interval)
{
...
void
VcwApWifiMac::SetCfpMaxDuration (Time duration)
{
...
int64_t
VcwApWifiMac::AssignStreams (int64_t stream)
{
...
bool
VcwApWifiMac::GetShortSlotTimeEnabled (void) const
{
...
bool
VcwApWifiMac::GetShortPreambleEnabled (void) const
{
...
bool
VcwApWifiMac::IsNonGfHtStasPresent (void) const
{
...
uint16_t
VcwApWifiMac::GetVhtOperationalChannelWidth (void) const
{
...
void
VcwApWifiMac::ForwardDown (Ptr<const Packet> packet, Mac48Address from,
                        Mac48Address to)
{
...
void
VcwApWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to, Mac48Address from)
{
...
void
VcwApWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
bool
VcwApWifiMac::SupportsSendFrom (void) const
{
  NS_LOG_FUNCTION (this);
  return true;
}
...
SupportedRates
VcwApWifiMac::GetSupportedRates (void) const
{
  NS_LOG_FUNCTION (this);
...
DsssParameterSet
VcwApWifiMac::GetDsssParameterSet (void) const
{
  NS_LOG_FUNCTION (this);
...
VcwApWifiMac::GetCapabilities (void) const
{
  NS_LOG_FUNCTION (this);
...
ErpInformation
VcwApWifiMac::GetErpInformation (void) const
{
  NS_LOG_FUNCTION (this);
...
EdcaParameterSet
VcwApWifiMac::GetEdcaParameterSet (void) const
{
  NS_LOG_FUNCTION (this);
...
CfParameterSet
VcwApWifiMac::GetCfParameterSet (void) const
{
...
HtOperation
VcwApWifiMac::GetHtOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
VhtOperation
VcwApWifiMac::GetVhtOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
HeOperation
VcwApWifiMac::GetHeOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
void
VcwApWifiMac::SendProbeResp (Mac48Address to)
{
...
void
VcwApWifiMac::SendAssocResp (Mac48Address to, bool success, bool isReassoc)
{
...
void
VcwApWifiMac::SendOneBeacon (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
  ...
  m_beaconEvent = Simulator::Schedule (GetBeaconInterval (), &VcwApWifiMac::SendOneBeacon, this);
...
void
VcwApWifiMac::SendNextCfFrame (void)
{
  if (!GetPcfSupported ())
    {
      return;
...
void
VcwApWifiMac::TxOk (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
VcwApWifiMac::TxFailed (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
VcwApWifiMac::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
VcwApWifiMac::DeaggregateAmsduAndForward (Ptr<Packet> aggregatedPacket, const WifiMacHeader *hdr)
{
...
void
VcwApWifiMac::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
      ...
      if (m_enableBeaconJitter)
        {
          ...
          m_beaconEvent = Simulator::Schedule (jitter, &VcwApWifiMac::SendOneBeacon, this);
        }
      else
        {
...
bool
VcwApWifiMac::GetUseNonErpProtection (void) const
{
...
bool
VcwApWifiMac::GetRifsMode (void) const
{
  bool rifsMode = false;
...
uint16_t
VcwApWifiMac::GetNextAssociationId (void)
{
...
void
VcwApWifiMac::IncrementPollingListIterator (void)
{
  NS_LOG_FUNCTION (this);
  m_itCfPollingList++;
  if (m_itCfPollingList == m_cfPollingList.end ())
