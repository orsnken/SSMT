...
#include "SsmtApWifiMac.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("SsmtApWifiMac");

NS_OBJECT_ENSURE_REGISTERED (SsmtApWifiMac);

TypeId
SsmtApWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SsmtApWifiMac")
    .SetParent<InfrastructureWifiMac> ()
    .SetGroupName ("Wifi")
    .AddConstructor<SsmtApWifiMac> ()
    .AddAttribute ("BeaconInterval",
                   "Delay between two beacons",
                   TimeValue (MicroSeconds (102400)),
                   MakeTimeAccessor (&SsmtApWifiMac::GetBeaconInterval,
                                     &SsmtApWifiMac::SetBeaconInterval),
                   MakeTimeChecker ())
    .AddAttribute ("CfpMaxDuration", "The maximum size of the CFP (used when AP supports PCF)",
                   TimeValue (MicroSeconds (51200)),
                   MakeTimeAccessor (&SsmtApWifiMac::GetCfpMaxDuration,
                                     &SsmtApWifiMac::SetCfpMaxDuration),
                   MakeTimeChecker ())
    ...
    .AddAttribute ("EnableNonErpProtection", "Whether or not protection mechanism should be used when non-ERP STAs are present within the BSS."
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&SsmtApWifiMac::m_enableNonErpProtection),
                   MakeBooleanChecker ())
    .AddAttribute ("RifsMode", "If non-HT STAs are detected, whether to force RIFS to be disabled within the BSS."
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&SsmtApWifiMac::m_disableRifs),
                   MakeBooleanChecker ())
  ;
  return tid;
}

SsmtApWifiMac::SsmtApWifiMac ()
  : m_enableBeaconGeneration (false)
{
  ...
  m_beaconTxop->SetTxOkCallback (MakeCallback (&SsmtApWifiMac::TxOk, this));
  m_rxMiddle->SetPcfCallback (MakeCallback (&SsmtApWifiMac::SendNextCfFrame, this));
...
void
SsmtApWifiMac::SetAddress (Mac48Address address)
{
...
void
SsmtApWifiMac::SetBeaconGeneration (bool enable)
{
  ...
  if (!enable)
    ...
    {
      m_beaconEvent = Simulator::ScheduleNow (&SsmtApWifiMac::SendOneBeacon, this);
    }
  m_enableBeaconGeneration = enable;
}

Time
SsmtApWifiMac::GetBeaconInterval (void) const
{
  NS_LOG_FUNCTION (this);
...
Time
SsmtApWifiMac::GetCfpMaxDuration (void) const
{
  NS_LOG_FUNCTION (this);
...
void
SsmtApWifiMac::SetWifiRemoteStationManager (const Ptr<WifiRemoteStationManager> stationManager)
{
...
void
SsmtApWifiMac::SetLinkUpCallback (Callback<void> linkUp)
{
...
void
SsmtApWifiMac::SetBeaconInterval (Time interval)
{
...
void
SsmtApWifiMac::SetCfpMaxDuration (Time duration)
{
...
int64_t
SsmtApWifiMac::AssignStreams (int64_t stream)
{
...
bool
SsmtApWifiMac::GetShortSlotTimeEnabled (void) const
{
...
bool
SsmtApWifiMac::GetShortPreambleEnabled (void) const
{
...
bool
SsmtApWifiMac::IsNonGfHtStasPresent (void) const
{
...
uint16_t
SsmtApWifiMac::GetVhtOperationalChannelWidth (void) const
{
...
void
SsmtApWifiMac::ForwardDown (Ptr<const Packet> packet, Mac48Address from,
                        Mac48Address to)
{
...
void
SsmtApWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to, Mac48Address from)
{
...
void
SsmtApWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
bool
SsmtApWifiMac::SupportsSendFrom (void) const
{
  NS_LOG_FUNCTION (this);
  return true;
}
...
SupportedRates
SsmtApWifiMac::GetSupportedRates (void) const
{
  NS_LOG_FUNCTION (this);
...
DsssParameterSet
SsmtApWifiMac::GetDsssParameterSet (void) const
{
  NS_LOG_FUNCTION (this);
...
SsmtApWifiMac::GetCapabilities (void) const
{
  NS_LOG_FUNCTION (this);
...
ErpInformation
SsmtApWifiMac::GetErpInformation (void) const
{
  NS_LOG_FUNCTION (this);
...
EdcaParameterSet
SsmtApWifiMac::GetEdcaParameterSet (void) const
{
  NS_LOG_FUNCTION (this);
...
CfParameterSet
SsmtApWifiMac::GetCfParameterSet (void) const
{
...
HtOperation
SsmtApWifiMac::GetHtOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
VhtOperation
SsmtApWifiMac::GetVhtOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
HeOperation
SsmtApWifiMac::GetHeOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
void
SsmtApWifiMac::SendProbeResp (Mac48Address to)
{
...
void
SsmtApWifiMac::SendAssocResp (Mac48Address to, bool success, bool isReassoc)
{
...
void
SsmtApWifiMac::SendOneBeacon (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
  ...
  m_beaconEvent = Simulator::Schedule (GetBeaconInterval (), &SsmtApWifiMac::SendOneBeacon, this);
...
void
SsmtApWifiMac::SendNextCfFrame (void)
{
  if (!GetPcfSupported ())
    {
      return;
...
void
SsmtApWifiMac::TxOk (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
SsmtApWifiMac::TxFailed (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
SsmtApWifiMac::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
SsmtApWifiMac::DeaggregateAmsduAndForward (Ptr<Packet> aggregatedPacket, const WifiMacHeader *hdr)
{
...
void
SsmtApWifiMac::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
      ...
      if (m_enableBeaconJitter)
        {
          ...
          m_beaconEvent = Simulator::Schedule (jitter, &SsmtApWifiMac::SendOneBeacon, this);
        }
      else
        {
...
bool
SsmtApWifiMac::GetUseNonErpProtection (void) const
{
...
bool
SsmtApWifiMac::GetRifsMode (void) const
{
  bool rifsMode = false;
...
uint16_t
SsmtApWifiMac::GetNextAssociationId (void)
{
...
void
SsmtApWifiMac::IncrementPollingListIterator (void)
{
  NS_LOG_FUNCTION (this);
  m_itCfPollingList++;
  if (m_itCfPollingList == m_cfPollingList.end ())
