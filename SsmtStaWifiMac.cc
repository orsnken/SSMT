...
#include "SsmtStaWifiMac.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("SsmtStaWifiMac");
NS_OBJECT_ENSURE_REGISTERED (SsmtStaWifiMac);

TypeId
SsmtStaWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SsmtStaWifiMac")
    .SetParent<InfrastructureWifiMac> ()
    .SetGroupName ("Wifi")
    .AddConstructor<SsmtStaWifiMac> ()
    .AddAttribute ("ProbeRequestTimeout", "The duration to actively probe the channel.",
                   TimeValue (Seconds (0.05)),
                   MakeTimeAccessor (&SsmtStaWifiMac::m_probeRequestTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("WaitBeaconTimeout", "The duration to dwell on a channel while passively scanning for beacon",
                   ...
                   MakeTimeAccessor (&SsmtStaWifiMac::m_waitBeaconTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("AssocRequestTimeout", "The interval between two consecutive association request attempts.",
                   TimeValue (Seconds (0.5)),
                   MakeTimeAccessor (&SsmtStaWifiMac::m_assocRequestTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("MaxMissedBeacons",
                   "Number of beacons which much be consecutively missed before "
                   "we attempt to restart association.",
                   UintegerValue (10),
                   MakeUintegerAccessor (&SsmtStaWifiMac::m_maxMissedBeacons),
    ...
    .AddAttribute ("ActiveProbing",
                   ...
                   BooleanValue (false),
                   MakeBooleanAccessor (&SsmtStaWifiMac::SetActiveProbing, &SsmtStaWifiMac::GetActiveProbing),
                   MakeBooleanChecker ())
    .AddTraceSource ("Assoc", "Associated with an access point.",
                     MakeTraceSourceAccessor (&SsmtStaWifiMac::m_assocLogger),
                     "ns3::Mac48Address::TracedCallback")
    .AddTraceSource ("DeAssoc", "Association with an access point lost.",
                     MakeTraceSourceAccessor (&SsmtStaWifiMac::m_deAssocLogger),
                     "ns3::Mac48Address::TracedCallback")
    .AddTraceSource ("BeaconArrival",
                     "Time of beacons arrival from associated AP",
                     MakeTraceSourceAccessor (&SsmtStaWifiMac::m_beaconArrival),
                     "ns3::Time::TracedCallback")
  ;
  return tid;
}

SsmtStaWifiMac::SsmtStaWifiMac ()
...
void
SsmtStaWifiMac::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
  StartScanning ();
}
...
void
SsmtStaWifiMac::SetActiveProbing (bool enable)
{
...
bool
SsmtStaWifiMac::GetActiveProbing (void) const
{
  return m_activeProbing;
}

void
SsmtStaWifiMac::SetWifiPhy (const Ptr<WifiPhy> phy)
{
  NS_LOG_FUNCTION (this << phy);
  RegularWifiMac::SetWifiPhy (phy);
  m_phy->SetCapabilitiesChangedCallback (MakeCallback (&SsmtStaWifiMac::PhyCapabilitiesChanged, this));
}

void
SsmtStaWifiMac::SetWifiRemoteStationManager (const Ptr<WifiRemoteStationManager> stationManager)
{
...
void
SsmtStaWifiMac::SendProbeRequest (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
...
void
SsmtStaWifiMac::SendAssociationRequest (bool isReassoc)
{
  ...
  m_assocRequestEvent = Simulator::Schedule (m_assocRequestTimeout,
                                             &SsmtStaWifiMac::AssocRequestTimeout, this);
}

void
SsmtStaWifiMac::SendCfPollResponse (void)
{
  NS_LOG_FUNCTION (this);
...
void
SsmtStaWifiMac::TryToEnsureAssociated (void)
{
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
...
void
SsmtStaWifiMac::StartScanning (void)
{
  NS_LOG_FUNCTION (this);
  ...
  if (GetActiveProbing ())
    {
      ...
      m_probeRequestEvent = Simulator::Schedule (m_probeRequestTimeout,
                                                 &SsmtStaWifiMac::ScanningTimeout,
                                                 this);
    }
  else
    {
...
void
SsmtStaWifiMac::ScanningTimeout (void)
{
  NS_LOG_FUNCTION (this);
...
void
SsmtStaWifiMac::AssocRequestTimeout (void)
{
  NS_LOG_FUNCTION (this);
  SetState (WAIT_ASSOC_RESP);
  SendAssociationRequest (false);
...
void
SsmtStaWifiMac::MissedBeacons (void)
{
  NS_LOG_FUNCTION (this);
  if (m_beaconWatchdogEnd > Simulator::Now ())
    {
      ...
      m_beaconWatchdog = Simulator::Schedule (m_beaconWatchdogEnd - Simulator::Now (),
                                              &SsmtStaWifiMac::MissedBeacons, this);
      return;
    }
...
void
SsmtStaWifiMac::RestartBeaconWatchdog (Time delay)
{
  ...
  if (Simulator::GetDelayLeft (m_beaconWatchdog) < delay
      && m_beaconWatchdog.IsExpired ())
    {
      ...
      m_beaconWatchdog = Simulator::Schedule (delay, &SsmtStaWifiMac::MissedBeacons, this);
    }
}

bool
SsmtStaWifiMac::IsAssociated (void) const
{
  return m_state == ASSOCIATED;
}

bool
SsmtStaWifiMac::IsWaitAssocResp (void) const
{
  return m_state == WAIT_ASSOC_RESP;
}

void
SsmtStaWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
void
SsmtStaWifiMac::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
SsmtStaWifiMac::UpdateCandidateApList (ApInfo newApInfo)
{
...
void
SsmtStaWifiMac::UpdateApInfoFromBeacon (MgtBeaconHeader beacon, Mac48Address apAddr, Mac48Address bssid)
{
...
void
SsmtStaWifiMac::UpdateApInfoFromProbeResp (MgtProbeResponseHeader probeResp, Mac48Address apAddr, Mac48Address bssid)
{
...
void
SsmtStaWifiMac::UpdateApInfoFromAssocResp (MgtAssocResponseHeader assocResp, Mac48Address apAddr)
{
...
SupportedRates
SsmtStaWifiMac::GetSupportedRates (void) const
{
...
SsmtStaWifiMac::GetCapabilities (void) const
{
...
void
SsmtStaWifiMac::SetState (MacState value)
{
  if (value == ASSOCIATED
      && m_state != ASSOCIATED)
    {
...
void
SsmtStaWifiMac::SetEdcaParameters (AcIndex ac, uint32_t cwMin, uint32_t cwMax, uint8_t aifsn, Time txopLimit)
{
...
void
SsmtStaWifiMac::PhyCapabilitiesChanged (void)
{
  NS_LOG_FUNCTION (this);
  if (IsAssociated ())
    {
