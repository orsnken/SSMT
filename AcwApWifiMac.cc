...
#include "AcwApWifiMac.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("AcwApWifiMac");

NS_OBJECT_ENSURE_REGISTERED (AcwApWifiMac);

TypeId
AcwApWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::AcwApWifiMac")
    .SetParent<InfrastructureWifiMac> ()
    .SetGroupName ("Wifi")
    .AddConstructor<AcwApWifiMac> ()
    .AddAttribute ("BeaconInterval",
                   "Delay between two beacons",
                   TimeValue (MicroSeconds (102400)),
                   MakeTimeAccessor (&AcwApWifiMac::GetBeaconInterval,
                                     &AcwApWifiMac::SetBeaconInterval),
                   MakeTimeChecker ())
    .AddAttribute ("CfpMaxDuration", "The maximum size of the CFP (used when AP supports PCF)",
                   TimeValue (MicroSeconds (51200)),
                   MakeTimeAccessor (&AcwApWifiMac::GetCfpMaxDuration,
                                     &AcwApWifiMac::SetCfpMaxDuration),
                   MakeTimeChecker ())
    ...
    .AddAttribute ("EnableNonErpProtection", "Whether or not protection mechanism should be used when non-ERP STAs are present within the BSS."
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&AcwApWifiMac::m_enableNonErpProtection),
                   MakeBooleanChecker ())
    .AddAttribute ("RifsMode", "If non-HT STAs are detected, whether to force RIFS to be disabled within the BSS."
                   ...
                   BooleanValue (true),
                   MakeBooleanAccessor (&AcwApWifiMac::m_disableRifs),
                   MakeBooleanChecker ())
  ;
  return tid;
}

AcwApWifiMac::AcwApWifiMac ()
  : m_enableBeaconGeneration (false)
{
  ...
  m_beaconTxop->SetTxOkCallback (MakeCallback (&AcwApWifiMac::TxOk, this));
  m_rxMiddle->SetPcfCallback (MakeCallback (&AcwApWifiMac::SendNextCfFrame, this));
...
void
AcwApWifiMac::SetAddress (Mac48Address address)
{
...
void
AcwApWifiMac::SetBeaconGeneration (bool enable)
{
  ...
  if (!enable)
    ...
    {
      m_beaconEvent = Simulator::ScheduleNow (&AcwApWifiMac::SendOneBeacon, this);
    }
  m_enableBeaconGeneration = enable;
}

Time
AcwApWifiMac::GetBeaconInterval (void) const
{
  NS_LOG_FUNCTION (this);
...
Time
AcwApWifiMac::GetCfpMaxDuration (void) const
{
  NS_LOG_FUNCTION (this);
...
void
AcwApWifiMac::SetWifiRemoteStationManager (const Ptr<WifiRemoteStationManager> stationManager)
{
...
void
AcwApWifiMac::SetLinkUpCallback (Callback<void> linkUp)
{
...
void
AcwApWifiMac::SetBeaconInterval (Time interval)
{
...
void
AcwApWifiMac::SetCfpMaxDuration (Time duration)
{
...
int64_t
AcwApWifiMac::AssignStreams (int64_t stream)
{
...
bool
AcwApWifiMac::GetShortSlotTimeEnabled (void) const
{
...
bool
AcwApWifiMac::GetShortPreambleEnabled (void) const
{
...
bool
AcwApWifiMac::IsNonGfHtStasPresent (void) const
{
...
uint16_t
AcwApWifiMac::GetVhtOperationalChannelWidth (void) const
{
...
void
AcwApWifiMac::ForwardDown (Ptr<const Packet> packet, Mac48Address from,
                        Mac48Address to)
{
...
void
AcwApWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to, Mac48Address from)
{
...
void
AcwApWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
bool
AcwApWifiMac::SupportsSendFrom (void) const
{
  NS_LOG_FUNCTION (this);
  return true;
}
...
SupportedRates
AcwApWifiMac::GetSupportedRates (void) const
{
  NS_LOG_FUNCTION (this);
...
DsssParameterSet
AcwApWifiMac::GetDsssParameterSet (void) const
{
  NS_LOG_FUNCTION (this);
...
AcwApWifiMac::GetCapabilities (void) const
{
  NS_LOG_FUNCTION (this);
...
ErpInformation
AcwApWifiMac::GetErpInformation (void) const
{
  NS_LOG_FUNCTION (this);
...
EdcaParameterSet
AcwApWifiMac::GetEdcaParameterSet (void) const
{
  NS_LOG_FUNCTION (this);
...
CfParameterSet
AcwApWifiMac::GetCfParameterSet (void) const
{
...
HtOperation
AcwApWifiMac::GetHtOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
VhtOperation
AcwApWifiMac::GetVhtOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
HeOperation
AcwApWifiMac::GetHeOperation (void) const
{
  NS_LOG_FUNCTION (this);
...
void
AcwApWifiMac::SendProbeResp (Mac48Address to)
{
...
void
AcwApWifiMac::SendAssocResp (Mac48Address to, bool success, bool isReassoc)
{
...
void
AcwApWifiMac::SendOneBeacon (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
  ...
  m_beaconEvent = Simulator::Schedule (GetBeaconInterval (), &AcwApWifiMac::SendOneBeacon, this);
...
void
AcwApWifiMac::SendNextCfFrame (void)
{
  if (!GetPcfSupported ())
    {
      return;
...
void
AcwApWifiMac::TxOk (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
AcwApWifiMac::TxFailed (const WifiMacHeader &hdr)
{
  NS_LOG_FUNCTION (this);
...
void
AcwApWifiMac::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
AcwApWifiMac::DeaggregateAmsduAndForward (Ptr<Packet> aggregatedPacket, const WifiMacHeader *hdr)
{
...
void
AcwApWifiMac::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
      ...
      if (m_enableBeaconJitter)
        {
          ...
          m_beaconEvent = Simulator::Schedule (jitter, &AcwApWifiMac::SendOneBeacon, this);
        }
      else
        {
...
bool
AcwApWifiMac::GetUseNonErpProtection (void) const
{
...
bool
AcwApWifiMac::GetRifsMode (void) const
{
  bool rifsMode = false;
...
uint16_t
AcwApWifiMac::GetNextAssociationId (void)
{
...
void
AcwApWifiMac::IncrementPollingListIterator (void)
{
  NS_LOG_FUNCTION (this);
  m_itCfPollingList++;
  if (m_itCfPollingList == m_cfPollingList.end ())
