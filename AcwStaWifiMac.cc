...
#include "AcwStaWifiMac.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("AcwStaWifiMac");
NS_OBJECT_ENSURE_REGISTERED (AcwStaWifiMac);

TypeId
AcwStaWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::AcwStaWifiMac")
    .SetParent<InfrastructureWifiMac> ()
    .SetGroupName ("Wifi")
    .AddConstructor<AcwStaWifiMac> ()
    .AddAttribute ("ProbeRequestTimeout", "The duration to actively probe the channel.",
                   TimeValue (Seconds (0.05)),
                   MakeTimeAccessor (&AcwStaWifiMac::m_probeRequestTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("WaitBeaconTimeout", "The duration to dwell on a channel while passively scanning for beacon",
                   ...
                   MakeTimeAccessor (&AcwStaWifiMac::m_waitBeaconTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("AssocRequestTimeout", "The interval between two consecutive association request attempts.",
                   TimeValue (Seconds (0.5)),
                   MakeTimeAccessor (&AcwStaWifiMac::m_assocRequestTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("MaxMissedBeacons",
                   "Number of beacons which much be consecutively missed before "
                   "we attempt to restart association.",
                   UintegerValue (10),
                   MakeUintegerAccessor (&AcwStaWifiMac::m_maxMissedBeacons),
    ...
    .AddAttribute ("ActiveProbing",
                   ...
                   BooleanValue (false),
                   MakeBooleanAccessor (&AcwStaWifiMac::SetActiveProbing, &AcwStaWifiMac::GetActiveProbing),
                   MakeBooleanChecker ())
    .AddTraceSource ("Assoc", "Associated with an access point.",
                     MakeTraceSourceAccessor (&AcwStaWifiMac::m_assocLogger),
                     "ns3::Mac48Address::TracedCallback")
    .AddTraceSource ("DeAssoc", "Association with an access point lost.",
                     MakeTraceSourceAccessor (&AcwStaWifiMac::m_deAssocLogger),
                     "ns3::Mac48Address::TracedCallback")
    .AddTraceSource ("BeaconArrival",
                     "Time of beacons arrival from associated AP",
                     MakeTraceSourceAccessor (&AcwStaWifiMac::m_beaconArrival),
                     "ns3::Time::TracedCallback")
  ;
  return tid;
}

AcwStaWifiMac::AcwStaWifiMac ()
...
void
AcwStaWifiMac::DoInitialize (void)
{
  NS_LOG_FUNCTION (this);
  StartScanning ();
}
...
void
AcwStaWifiMac::SetActiveProbing (bool enable)
{
...
bool
AcwStaWifiMac::GetActiveProbing (void) const
{
  return m_activeProbing;
}

void
AcwStaWifiMac::SetWifiPhy (const Ptr<WifiPhy> phy)
{
  NS_LOG_FUNCTION (this << phy);
  RegularWifiMac::SetWifiPhy (phy);
  m_phy->SetCapabilitiesChangedCallback (MakeCallback (&AcwStaWifiMac::PhyCapabilitiesChanged, this));
}

void
AcwStaWifiMac::SetWifiRemoteStationManager (const Ptr<WifiRemoteStationManager> stationManager)
{
...
void
AcwStaWifiMac::SendProbeRequest (void)
{
  NS_LOG_FUNCTION (this);
  WifiMacHeader hdr;
...
void
AcwStaWifiMac::SendAssociationRequest (bool isReassoc)
{
  ...
  m_assocRequestEvent = Simulator::Schedule (m_assocRequestTimeout,
                                             &AcwStaWifiMac::AssocRequestTimeout, this);
}

void
AcwStaWifiMac::SendCfPollResponse (void)
{
  NS_LOG_FUNCTION (this);
...
void
AcwStaWifiMac::TryToEnsureAssociated (void)
{
  NS_LOG_FUNCTION (this);
  switch (m_state)
    {
...
void
AcwStaWifiMac::StartScanning (void)
{
  NS_LOG_FUNCTION (this);
...
void
AcwStaWifiMac::ScanningTimeout (void)
{
  NS_LOG_FUNCTION (this);
...
void
AcwStaWifiMac::AssocRequestTimeout (void)
{
  NS_LOG_FUNCTION (this);
  SetState (WAIT_ASSOC_RESP);
  SendAssociationRequest (false);
...
void
AcwStaWifiMac::MissedBeacons (void)
{
  NS_LOG_FUNCTION (this);
  if (m_beaconWatchdogEnd > Simulator::Now ())
    {
      ...
      m_beaconWatchdog = Simulator::Schedule (m_beaconWatchdogEnd - Simulator::Now (),
                                              &AcwStaWifiMac::MissedBeacons, this);
      return;
    }
...
void
AcwStaWifiMac::RestartBeaconWatchdog (Time delay)
{
  ...
  if (Simulator::GetDelayLeft (m_beaconWatchdog) < delay
      && m_beaconWatchdog.IsExpired ())
    {
      ...
      m_beaconWatchdog = Simulator::Schedule (delay, &AcwStaWifiMac::MissedBeacons, this);
    }
}

bool
AcwStaWifiMac::IsAssociated (void) const
{
  return m_state == ASSOCIATED;
}

bool
AcwStaWifiMac::IsWaitAssocResp (void) const
{
  return m_state == WAIT_ASSOC_RESP;
}

void
AcwStaWifiMac::Enqueue (Ptr<const Packet> packet, Mac48Address to)
{
...
void
AcwStaWifiMac::Receive (Ptr<Packet> packet, const WifiMacHeader *hdr)
{
...
void
AcwStaWifiMac::UpdateCandidateApList (ApInfo newApInfo)
{
...
void
AcwStaWifiMac::UpdateApInfoFromBeacon (MgtBeaconHeader beacon, Mac48Address apAddr, Mac48Address bssid)
{
...
void
AcwStaWifiMac::UpdateApInfoFromProbeResp (MgtProbeResponseHeader probeResp, Mac48Address apAddr, Mac48Address bssid)
{
...
void
AcwStaWifiMac::UpdateApInfoFromAssocResp (MgtAssocResponseHeader assocResp, Mac48Address apAddr)
{
...
SupportedRates
AcwStaWifiMac::GetSupportedRates (void) const
{
...
AcwStaWifiMac::GetCapabilities (void) const
{
...
void
AcwStaWifiMac::SetState (MacState value)
{
  if (value == ASSOCIATED
      && m_state != ASSOCIATED)
    {
...
void
AcwStaWifiMac::SetEdcaParameters (AcIndex ac, uint32_t cwMin, uint32_t cwMax, uint8_t aifsn, Time txopLimit)
{
...
void
AcwStaWifiMac::PhyCapabilitiesChanged (void)
{
  NS_LOG_FUNCTION (this);
  if (IsAssociated ())
    {
