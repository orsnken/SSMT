...
#ifndef VCW_STA_WIFI_MAC_H
#define VCW_STA_WIFI_MAC_H
 ...
 */
class VcwStaWifiMac : public InfrastructureWifiMac
{
public:
  /**
...
private:
  ...
  void SetMaxCw (int cw);
  int GetMaxCw (void) const;

  void SetMinCw (int cw);
  int GetMinCw (void) const;
